...
TEST_F(vectorOperationsTest, scaleUpperVectorPadding)
{
    ...
    // scale upper 3 blocks of b
    MatrixOperations::scaleVectorBlock(queue, b.rightHandSideData.data(), 1.23456, result.data(), 0, 2);
    queue.wait();
...
TEST_F(vectorOperationsTest, scaleLowerVectorPadding)
{
    ...
    // scale lower 2 blocks of b
    MatrixOperations::scaleVectorBlock(queue, b.rightHandSideData.data(), 1.23456, result.data(), 2, 2);
    queue.wait();
...
TEST_F(vectorOperationsTest, addLowerVectorPadding)
{
    ...
    // add lower 2 blocks of b + b
    MatrixOperations::addVectorBlock(queue, b.rightHandSideData.data(), b.rightHandSideData.data(), result.data(), 2,
                                     2);
    queue.wait();
...
TEST_F(vectorOperationsTest, subLowerVectorPadding)
{
    ...
    // sub lower 2 blocks of b - y
    MatrixOperations::subVectorBlock(queue, b.rightHandSideData.data(), y.data(), result.data(), 2,
                                     2);
    queue.wait();
